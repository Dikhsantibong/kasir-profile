...
<header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <a class="navbar-brand w-auto" href="{{ url('/') }}">
            <!-- logo dark-->
            <img class="logo dark img-fluid" src="{{ asset('nova-template/assets/images/logo-dark.svg') }}" alt="FreeBootstrap.net image placeholder">
            <!-- logo light-->
            <img class="logo light img-fluid" src="{{ asset('nova-template/assets/images/logo-light.svg') }}" alt="FreeBootstrap.net image placeholder">
        </a>
        <!-- End Logo-->
