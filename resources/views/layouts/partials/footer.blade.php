    ...
    <div class="container">
      ...
      <div class="row credits pt-3">
        <div class="col-xl-8 text-center text-xl-start mb-3 mb-xl-0">
          ...
          -->
          &copy;
          <script>document.write(new Date().getFullYear());</script> KasirCerdas.
           All rights reserved. by PT KREATIF TEKNOLOGI MAJU BERSAMA
        </div>
        <div class="col-xl-4 justify-content-start justify-content-xl-end quick-links d-flex flex-column flex-xl-row text-center text-xl-start gap-1">Distributed by<a href="https://ctechagency.io" target="_blank">Creative Tech</a></div>
      </div>
    </div>
  </footer>
  <!-- End Footer-->